#!/usr/bin/env python3
"""Line chart of biblical quote counts by year."""
...
def build_chart(df: pd.DataFrame, output_path: Path) -> None:
    ...
    ax.set_title("Biblical Quotes by Year")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Line chart of biblical quote counts by year."
    )
    parser.add_argument(
        "--input",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results/figures/biblical_quotes_by_year.png"),
